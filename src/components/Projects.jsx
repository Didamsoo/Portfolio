      ...
      {modalProject && (
        <div className="modal" onClick={closeModal} aria-modal="true" role="dialog">
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <p><strong>{t('description')} :</strong> {modalProject.description}</p>
            <p><strong>{t('technologies')} :</strong> {modalProject.technologies}</p>
            <p><strong>{t('challenges')} :</strong> {modalProject.challenges}</p>
            <p>
              <a 
